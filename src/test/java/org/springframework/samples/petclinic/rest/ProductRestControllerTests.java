...
public class ProductRestControllerTests {
    ...
    public void initProducts(){
    	...
    	golden.setDescription("Formulada com ingredientes de alta qualidade e balanceada para suprir às particularidades nutricionais dos felinos.");
    	
    	products.add(golden);
    }

    @Test
    public void testGetAllProductSuccess() throws Exception {
    ...
    @Test
    public void testGetAllProductNotFound() throws Exception {
    	products.clear();
    	given(this.clinicService.findAllProducts()).willReturn(products);
